...
const DEFAULTS = {
  ...
  taskPath: path.join(ROOT, 'prompts', 'tasks', 'select-book-discover.md'),
  lensPaths: [
    path.join(ROOT, 'prompts', 'lenses', 'game-theory.md'),
  ...
  outputPrefix: 'book-selection__case-002__new-system',
};
...
- In discover mode, do not collapse into generic workplace books unless they explicitly beat lens-native candidates.
- Match the fixture language.
`.trim(),
  ].join('\n\n---\n\n');

  const userPrompt = `Test fixture for case-002:
